function [X] = alignrigidablation(X,Y,param)
    ...
    paramFM = standardparams;
    paramFM.facFeat = 1000;
    paramFM.noPlot = true;
    ainit = zeros(1,3);
    
    
    problemSize = paramFM.problemSizeInit;
    ...
    kArray = 2:kTest;
    [feat] = computefunctionalmap(X,Y,paramFM,feat,kTest);
